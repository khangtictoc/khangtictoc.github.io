...
This post aims to show (in theory) the differences between AWS services. Thus, developers are able to think wisely and pick up the most suitable ones for their company's stacks.
